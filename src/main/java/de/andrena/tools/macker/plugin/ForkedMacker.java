 ...
 * <code>org.codehaus.mojo.cobertura.tasks.AbstractTask</code>. This uses the
 * Shell from CommandLine for forking. In Windows XP this has a max of 8kb
 * command line arguments. So we have to use a command file.
 * 
